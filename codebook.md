<p align="center">
  <b><span style="font-size:20px;">Swiss Legislative Processes Codebook (LegPro)</span></b><br>
</p>
...
|-------------|---------------------------------------------------|
| [`bill_id`]{#billid} | Bill unique ID formed by `proposal_id` and `bill_proposal_number`	|
